...
public class MainMenu extends ListActivity implements SensorEventListener{
    ...
    ArrayAdapter<Float> axisAdapter;
    Vibrator vib;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tr1 = (TableRow) findViewById(R.id.row1);tr6 = (TableRow) findViewById(R.id.row6);
        tr2 = (TableRow) findViewById(R.id.row2);tr7 = (TableRow) findViewById(R.id.row7);
        tr3 = (TableRow) findViewById(R.id.row3);tr8 = (TableRow) findViewById(R.id.row8);
        tr4 = (TableRow) findViewById(R.id.row4);tr9 = (TableRow) findViewById(R.id.row9);
        tr5 = (TableRow) findViewById(R.id.row5);tr10 = (TableRow) findViewById(R.id.row10);

        thread();


    }
    public void goToUpt(View v){
    ...
    public void detected() {
        ...
        } else if (magnitude >= 2 && magnitude <= 2.9) { if (id.size() == 1) {
            TableRow table = (TableRow) findViewById(id.get(0));
            table.setBackgroundColor(0);
            id.clear();
        }
        ...
        } else if (magnitude >= 3 && magnitude <= 3.9) {if (id.size() == 1) {
            TableRow table = (TableRow) findViewById(id.get(0));
            table.setBackgroundColor(0);
            id.clear();
        }
        ...
        } else if (magnitude >= 4 && magnitude <= 4.9) {if (id.size() == 1) {
            TableRow table = (TableRow) findViewById(id.get(0));
            table.setBackgroundColor(0);
            id.clear();
        }
        ...
        } else if (magnitude >= 5 && magnitude <= 5.9) { if (id.size() == 1) {
            TableRow table = (TableRow) findViewById(id.get(0));
            table.setBackgroundColor(0);
            id.clear();
        }
        ...
        } else if (magnitude >= 6 && magnitude <= 6.9) { if (id.size() == 1) {
            TableRow table = (TableRow) findViewById(id.get(0));
            table.setBackgroundColor(0);
            id.clear();
        }
        ...
        } else if (magnitude >= 7 && magnitude <= 7.9) { if (id.size() == 1) {
            TableRow table = (TableRow) findViewById(id.get(0));
            table.setBackgroundColor(0);
            id.clear();
        }
        ...
        } else if (magnitude >= 8 && magnitude <= 8.9) {if (id.size() == 1) {
            TableRow table = (TableRow) findViewById(id.get(0));
            table.setBackgroundColor(0);
            id.clear();
        }
        ...
        } else if (magnitude >= 9 && magnitude <= 9.9) { if (id.size() == 1) {
            TableRow table = (TableRow) findViewById(id.get(0));
            table.setBackgroundColor(0);
            id.clear();
        }
